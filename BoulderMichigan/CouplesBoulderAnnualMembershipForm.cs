...
{
    public partial class frm_CouplesBoulderAnnualMembershipForm : Form
    {
        public frm_CouplesBoulderAnnualMembershipForm()
        {
            InitializeComponent();
        }
        
private void btn_CouplesBoulderAnnualMembership_Click(object sender, EventArgs e)
        {
